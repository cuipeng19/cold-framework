...
public final class ObjectId implements Comparable<ObjectId>, Serializable {
    ...
    private static final long serialVersionUID = 4188340893198510711L;

    private static final Logger objectIdLogger = LoggerFactory.getLogger(ObjectId.class);
    ...
    private static int createMachineIdentifier() {
        ...
        try {
            ...
            objectIdLogger.warn( "Failed to get machine identifier from network interface, using random number instead", t);
        }
    ...
    private static short createProcessIdentifier() {
        ...
        try {
            ...
            objectIdLogger.warn("Failed to get process identifier from JMX, using random number instead", t);
        }
